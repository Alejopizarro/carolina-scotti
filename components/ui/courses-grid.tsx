    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-12 w-full text-center mt-2 sm:mt-12">
      <div className="flex flex-col border h-fit bg-white rounded-lg shadow-xl p-4">
        ...
        <div className="flex flex-col gap-2 px-4">
          ...
          <p className="text-gray-500 text-sm mb-4">
            Programa grupal online de 5 encuentros donde aprenderás a comprender
            lo que sucede en tu cuerpo y tu mente, y entrenarás estrategias para
            atravesar los episodios con mayor calma y seguridad.
          </p>
      ...
      <div className="flex flex-col border scale-y-105 border-rose-300 bg-white rounded-lg shadow-xl p-4">
        ...
        <div className="flex flex-col gap-2 px-4">
          ...
          <p className="text-gray-500 text-sm mb-4">
            Entrenamiento grupal paso a paso para aprender a manejar la ansiedad
            y el estrés. Vas a trabajar técnicas prácticas de respiración,
            regulación emocional y cambio de pensamiento para sentirte más clara
            y enfocada en tu día a día.
          </p>
          <p className="text-gray-500 text-sm">
            Nota: Este es un programa educativo. No sustituye una terapia
            individual.
      ...
      <div className="flex flex-col border h-fit bg-white rounded-lg shadow-xl p-4">
        ...
        <div className="flex flex-col gap-2 px-4">
          ...
          <p className="text-gray-500 text-sm mb-4">
            ...
            volar. Incluye estrategias de preparación antes del vuelo, técnicas
            de regulación durante el trayecto y recursos para mantener la calma
            después.
          </p>
          <p className="text-gray-500 text-sm">
            Nota: Este es un programa educativo. No sustituye una terapia
