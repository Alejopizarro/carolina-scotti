    ...
    <div className="2xl:max-w-7xl mx-auto overflow-hidden relative">
      <div className="flex flex-col gap-8 md:flex-row py-8 min-h-[100vh] items-center justify-center">
        ...
        <div className="relative z-10">
          <div className="bg-gray-50/70 border-1 border-white gap-2 px-4 py-2 rounded-lg shadow-md absolute top-5 lg:top-10 right-55 lg:right-72">
          ...
          <div className="bg-gray-50/70 border-1 border-white gap-2 px-4 py-2 rounded-lg shadow-md absolute bottom-10 left-52 lg:left-72">
            <p className="font-bold w-max text-4xl flex flex-col">
              + 2000
      ...
      <div className="bg-[url('/background-blob.png')] bg-center ">
        <div className="px-4 py-8 flex flex-col z-10 justify-center text-center max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 text-xl text-center sm:grid-cols-2 sm:gap-8 md:text-left my-8 sm:mb-16">
